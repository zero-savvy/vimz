# **VIMz**: Verifiable Image Manipulation via Folding-based zkSNARKs [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.12516128.svg)](https://doi.org/10.5281/zenodo.12516128) <!-- omit in toc -->

![vimzRepoImage](cover.png)
