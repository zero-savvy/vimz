...
pub type DeciderParams<Circuit> = (DeciderProverParam<Circuit>, DeciderVerifierParam<Circuit>);
pub type DeciderProverParam<Circuit> =
    <Decider<Circuit> as DeciderTrait<G1, G2, Circuit, Folding<Circuit>>>::ProverParam;
